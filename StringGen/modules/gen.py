...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Dhiman_Network"))
        else:
            ...
            await client.join_chat("Dhiman_Network")
    except KeyError:
        pass
    try:
